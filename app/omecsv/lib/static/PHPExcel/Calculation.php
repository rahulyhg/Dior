...
require PHPEXCEL_ROOT.'/PHPExcel/Calculation/Database.php';
require PHPEXCEL_ROOT.'/PHPExcel/Calculation/DateTime.php';
require PHPEXCEL_ROOT.'/PHPExcel/Calculation/Engineering.php';
require PHPEXCEL_ROOT.'/PHPExcel/Calculation/Exception.php';
require PHPEXCEL_ROOT.'/PHPExcel/Calculation/ExceptionHandler.php';
require PHPEXCEL_ROOT.'/PHPExcel/Calculation/Financial.php';
require PHPEXCEL_ROOT.'/PHPExcel/Calculation/FormulaParser.php';
require PHPEXCEL_ROOT.'/PHPExcel/Calculation/FormulaToken.php';
require PHPEXCEL_ROOT.'/PHPExcel/Calculation/Function.php';
require PHPEXCEL_ROOT.'/PHPExcel/Calculation/Functions.php';
require PHPEXCEL_ROOT.'/PHPExcel/Calculation/Logical.php';
require PHPEXCEL_ROOT.'/PHPExcel/Calculation/LookupRef.php';
require PHPEXCEL_ROOT.'/PHPExcel/Calculation/MathTrig.php';
