 ...
 * 操作日志操作名称定义
 * @author ome
 * @copyright www.shopex.cn 2011.2.21
 *
 */
class ome_operation_log{
    ...
    function get_operations(){
        $operations = array(
           ...
           'goods_import'=>array('name'=>'商品导入','type'=>'goods@ome'),
            ...
            'invoice_delete' => array('name'=> '发票删除','type' => 'order@invoice'),
            'invoice_import' => array('name'=> '需开发票订单导入','type' => 'order@invoice'),
            'invoice_confirm' => array('name'=> '发票确认','type' => 'order@invoice'),
            'invoice_dispatch' => array('name'=> '发票调度','type' => 'order@invoice'),
    ...
    public static function getIOItem($type = '') {
        ...
        $itemType = array(
            ...
            'goods_goodsBingding_bindingGoods_export' => array('name' => '商品-商品捆绑-捆绑商品-导出', 'type' => 'export@ome', 'operation' => '0033@omepkg', 'obj_id' => '100000000033', 'obj_name' => '100000000033-0033'),
            ...
            'delivery_third_quick_import' => array('name'=> '发货-第三方发货-快速发货-导入', 'type' => 'import@ome', 'operation' => '5012@omepkg', 'obj_id' => '100000005012', 'obj_name' => '100000005012-5012'),
