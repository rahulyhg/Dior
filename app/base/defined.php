...
//    
//    if ($set) {
//        $constants['MATRIX_URL'] = $set['bind_url'];
//        $constants['MATRIX_RELATION_URL'] = $set['bind_url'];
//        $constants['LICENSE_CENTER_V'] = $set['license_url'];
//        $constants['LICENSE_CENTER']= $set['license_url'];
//        $constants['PRISM_BASE_URL'] = $set['base_url'];
//        $constants['PRISM_APP_KEY'] = $set['app_key'];
//        $constants['PRISM_APP_SECRET'] = $set['app_secret'];
//    }
//}
