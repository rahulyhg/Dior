<?php 
class qmwms_request_xml extends erpapi_format_abstract{
    ...
    public function data_encode($arr=array()) {
        ...
        if (count($arr) == 1) {
            ...
            $node_name = 'request'; $data = $arr;
        }

        $node_name = count($arr) == 1 ? key($arr) : 'request';
    ...
    function _array2xml($array, $root_tag=NULL, $xmlns='') {
        if ($root_tag == NULL) {
