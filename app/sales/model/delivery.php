...
/**
	...
	* 商品销售发货明细类
*/
class sales_mdl_delivery extends ome_mdl_sales{
           ...
           $additional_costs = 0;
            ...
            foreach($data as $k=>$v){
               ...
               if(!empty($v['product_id'])){
                   $sql = 'select p.name,g.type_id,g.brand_id from sdb_ome_products p,sdb_ome_goods g where product_id='.$v['product_id'];
