...
*/
class apibusiness_response_order_amazon_b2bv1 extends apibusiness_response_order_amazon_abstract
{
    /**
     * 是否接收订单
     *
    ...
    protected function canAccept()
    {
        ...
        $this->_apiLog['info']['msg'] = '亚马逊分销订单暂时不接收';
