...
*/
class apibusiness_response_order_dangdang_b2bv1 extends apibusiness_response_order_dangdang_abstract
{
    /**
     * 是否接收订单
     *
    ...
    protected function canAccept()
    {
        ...
        $this->_apiLog['info']['msg'] = '当当分销订单暂时不接收';
